...
An LLM-based text vectorization and qualitative analysis playground to extract themes, patterns, and semantic structure from unstructured textual data.

This project combines embedding models with large language models to support qualitative research, document analysis, and exploratory text analysis at scale.
